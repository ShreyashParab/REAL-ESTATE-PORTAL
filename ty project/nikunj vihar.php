<?php
  require 'config.php';
  $sql = "SELECT * FROM `propertylist` WHERE name='nikunj vihar'";
...
<div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-content">
          <h2 class = "product-title">Nikunj Vihar</h2>
          ...
          <div class = "product-detail">
            ...
            <p>This is an exotic property of delhi. It presents almost all fascilities with new technology. This contain modern feature like Clubhouse, Swimingpool, Gym, Meditation room and even Banquet. Besides that the Balcony view is superb. For more detailed information about property and Buying details Contact to our Broker/Owner from below Contact no.:</p>
            <!-- <p><h6>CONTACT US NOW...!!!</h6></p> -->
            <ul>
              <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.959 17l-4.5-4.319 1.395-1.435 3.08 2.937 7.021-7.183 1.422 1.409-8.418 8.591z"/></svg> Price: <span>60.00Lk</span></li>
              ...
              <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.959 17l-4.5-4.319 1.395-1.435 3.08 2.937 7.021-7.183 1.422 1.409-8.418 8.591z"/></svg> size: <span>3250 X 4520 sq. m.</span></li>
